...
type ReviewResourceReq struct {
	...
	Channel string     `protobuf:"bytes,5,opt,name=channel,proto3" json:"channel,omitempty"` // 审核渠道
}
...
type ReviewResourceRes struct {
	...
	State ResultState `protobuf:"varint,1,opt,name=state,proto3,enum=svc.user.ResultState" json:"state,omitempty"` // 根据需求添加其他字段
}
