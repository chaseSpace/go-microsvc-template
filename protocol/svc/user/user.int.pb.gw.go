...
func request_UserInt_GetUser_0(ctx context.Context, marshaler runtime.Marshaler, client UserIntClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetUserIntReq
...
func local_request_UserInt_GetUser_0(ctx context.Context, marshaler runtime.Marshaler, server UserIntServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetUserIntReq
	var metadata runtime.ServerMetadata
...
func request_UserInt_Test_0(ctx context.Context, marshaler runtime.Marshaler, client UserIntClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_UserInt_Test_0(ctx context.Context, marshaler runtime.Marshaler, server UserIntServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TestReq
	var metadata runtime.ServerMetadata
...
func RegisterUserIntHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserIntServer) error {
	...
	mux.Handle("POST", pattern_UserInt_GetUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_UserInt_GetUser_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_UserInt_GetUser_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_UserInt_Test_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_UserInt_Test_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_UserInt_Test_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterUserIntHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserIntClient) error {
	...
	mux.Handle("POST", pattern_UserInt_GetUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_UserInt_GetUser_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_UserInt_Test_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_UserInt_Test_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	forward_UserInt_GetUser_0 = runtime.ForwardResponseMessage

	forward_UserInt_Test_0 = runtime.ForwardResponseMessage
)
