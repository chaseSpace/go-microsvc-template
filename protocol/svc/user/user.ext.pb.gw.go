...
func RegisterUserExtHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserExtServer) error {
	...
	mux.Handle("POST", pattern_UserExt_GetUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.svc.user.UserExt/GetUser", runtime.WithHTTPPathPattern("/v1/GetUser"))
		if err != nil {
...
func RegisterUserExtHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserExtClient) error {
	...
	mux.Handle("POST", pattern_UserExt_GetUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.svc.user.UserExt/GetUser", runtime.WithHTTPPathPattern("/v1/GetUser"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_UserExt_GetUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "GetUser"}, ""))
)
